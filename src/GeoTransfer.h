...
public:
    ...
    bool        Export2GCD(const char* pszGcdPath) const;
    ...
    bool        IsSameSpatialReference(CGeoTransferBase* sr) const;
    bool        IsSameGeogCS(CGeoTransferBase* sr) const;
    bool        IsSameVertCS(CGeoTransferBase* sr) const;
