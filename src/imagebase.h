...
public:
    ...
    */
    ...
    void    GetGeoXY(double* x, double* y) const;
    void    GetImgXY(double* x, double* y) const;
    ...
    bool GetStatistics(int nBandIdx, double *pdfMin, double *pdfMax, double *pdfMean, double *padfStdDev) const;

    void            GetGeoTransform(double * padfTransform, bool bPixelCenter = true) const;
    ...
    */
    ...
    bool            CopyGeoInformation(const CImageBase& img);
...
inline static bool SaveImageFile(const char *strImgName, void *pImg, int cols, int rows, int bands, int bits = 8, double* padfGeoTransform = NULL, const char* lpstrWkt = NULL)
{
